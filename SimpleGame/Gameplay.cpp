...
void Gameplay::Init()
{
	...
	//Actor Input
	{
		...
		//IdleInput.AddKeyMapping(CYAN_SPACE, CMD::START_CHARGE_JUMP);
		//IdleInput.AddKeyMapping(CYAN_RIGHT, CMD::START_SHOOT);
		//IdleInput.AddKeyMapping(CYAN_LEFT, CMD::START_SHOOT);
		//IdleInput.AddKeyMapping(CYAN_UP, CMD::START_SHOOT);
		//IdleInput.AddKeyMapping(CYAN_DOWN, CMD::START_SHOOT);
		...
		//MoveInput.AddKeyMapping(CYAN_SPACE, CMD::START_CHARGE_JUMP);
		//MoveInput.AddKeyMapping(CYAN_RIGHT, CMD::START_SHOOT);
		//MoveInput.AddKeyMapping(CYAN_LEFT, CMD::START_SHOOT);
		//MoveInput.AddKeyMapping(CYAN_UP, CMD::START_SHOOT);
		//MoveInput.AddKeyMapping(CYAN_DOWN, CMD::START_SHOOT);
		...
		//ChargeJump.AddKeyMapping(CYAN_SPACE, CMD::START_IN_AIR);

		Input&  InAirInput = Engine.GetStateInput(OBJ::PLAYER, ST::IN_AIR);
		//InAirInput.AddKeyMapping(CYAN_SPACE, CMD::START_CHARGE_SLAM);
		...
		//ShootInput.AddKeyMapping(CYAN_RIGHT,CMD::FACE_RIGHT);
		//ShootInput.AddKeyMapping(CYAN_LEFT,	CMD::FACE_LEFT);
		//ShootInput.AddKeyMapping(CYAN_UP,	CMD::FACE_UP);
		//ShootInput.AddKeyMapping(CYAN_DOWN,	CMD::FACE_DOWN);
		//ShootInput.AddKeyMapping(CYAN_RIGHT,CMD::END_SHOOT);
		//ShootInput.AddKeyMapping(CYAN_LEFT,	CMD::END_SHOOT);
		//ShootInput.AddKeyMapping(CYAN_UP,	CMD::END_SHOOT);
		//ShootInput.AddKeyMapping(CYAN_DOWN,	CMD::END_SHOOT);
		//
